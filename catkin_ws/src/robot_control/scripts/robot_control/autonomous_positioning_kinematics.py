...
def autonomous_positioning():
    try:
        ...
        # Define robots: robot_si:surgical instrument, robot_lg:light guide
        ...
        t_rcm_si, t_rcm_lg = om_kinematics.get_current_rcm_translations(t_si_inserted, t_lg_inserted, l_si, l_lg,
        ...
        if functions.is_physical_robot():
            ...
            print("[" + rospy.get_name() + "]:: Moving the tool-tips to the start positions...\n")
